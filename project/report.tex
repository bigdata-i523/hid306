...
\end{figure}
	...
	\begin{itemize}
		...
		\item  ExterQual: Filled null values with {\em TA} (Categorized - 2)
		\item  BsmtQual: Filled null values with {\em TA} (Categorized - 2)
